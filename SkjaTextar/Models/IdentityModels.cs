...
namespace SkjaTextar.Models
{
    ...
    public class ApplicationInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {
                new Show{ ID = 4, CategoryID = 4, Title = "Svampur Sveinsson", Series = 2, Episode = 13, ReleaseYear = 2009, Active = true },
                new Show{ ID = 5, CategoryID = 4, Title = "Svampur Sveinsson", Series = 2, Episode = 14, ReleaseYear = 2009, Active = true },
                new Show{ ID = 6, CategoryID = 3, Title = "House of cards", Series = 1, Episode = 3, ReleaseYear = 2013, Active = true },
                new Show{ ID = 7, CategoryID = 1, Title = "How i met your mother", Series = 7, Episode = 13, ReleaseYear = 2011, Active = true },
            };
            ...
            {
                new Clip{ ID = 8, CategoryID = 1, Title = "Nyan cat", ReleaseYear = 2009, Link = "www.youtube.com/watch?v=wZZ7oFKsKzY", Active = true },
