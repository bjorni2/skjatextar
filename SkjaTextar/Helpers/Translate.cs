...
namespace SkjaTextar.Helpers
{
    ...
    {
        public void TranslateText(Translation trans, string to, string from = "en")
        {
        ...
        private String TranslateMethod(string authToken, string toTranslate, string to, string from = "en")
        {
